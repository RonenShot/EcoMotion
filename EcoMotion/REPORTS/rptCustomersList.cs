...
{
    public partial class rptCustomersList : Form
    {
        public rptCustomersList()
        {
            InitializeComponent();
        }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("דוח פירוט לקוחות ", new Font("Tahoma", 14,
        ...
        private void rptCustomersList_Load(object sender, EventArgs e)
        {
        ...
        public void PresntSql(int r)
        {
            ...
            {
                case 1:
                    stSql = "SELECT * FROM Customer ORDER BY ID ASC"; // סדר עולה
                    break;
                case 2:
                    stSql = "SELECT * FROM Customer ORDER BY ID DESC";//  סדר יורד 
                    break;
                case 3:
            ...
            Tcustomer = dbEcoMotion.ds.Tables[0];
            dataGridView1.DataSource = Tcustomer;
