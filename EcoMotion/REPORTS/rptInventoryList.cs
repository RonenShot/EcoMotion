...
{
    public partial class rptInventoryList : Form
    {
        public rptInventoryList()
        {
            InitializeComponent();
        }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("דוח פירוט מלאי מנועים ", new Font("Tahoma", 14,
        ...
        private void rptInventoryList_Load(object sender, EventArgs e)
        {
        ...
        public void PresntSql(int r)
        {
            ...
            {
                case 1:
                    stSql = "SELECT * FROM Inventory ORDER BY quntity ASC"; // סדר עולה
                    break;
                case 2:
                    stSql = "SELECT * FROM Inventory ORDER BY quntity DESC";//  סדר יורד 
                    break;
                case 3:
                    stSql = "select * from Inventory where Active='כן'";
                    break;
                case 4:
                    stSql = "select * from Inventory where Active='לא'";
                    break;
                case 5:
                    stSql = "select * from Inventory where Active='לא'";
                    break;
            ...
            Tinventory = dbEcoMotion.ds.Tables[0];
            dataGridView1.DataSource = Tinventory;
